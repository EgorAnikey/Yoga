...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var tabs = __webpack_require__(/*! ./parts/tabs.js */ "./src/parts/tabs.js"),
      ...
      scrollSlow = __webpack_require__(/*! ./parts/scroll.js */ "./src/parts/scroll.js"),
  ...
  function animation(img, a) {
    ...
    function start() {
      ...
      if (opac < -0) {
        ...
        img.style.transform = "scale(".concat(i, ", ").concat(i, ")");
      }
    }
  }
  ...
  prev.addEventListener('click', function () {
    slides.forEach(function (item) {
      if (item.style.display == 'block') {
        var bigImg = item.querySelector('.slider-item img');
...
function tabs(headerClassName, tabClassName, infoContentClassName) {
...
function timer() {
  var deadline = '2019-03-27T00:00:00';
